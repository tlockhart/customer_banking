...
def validate_input(prompt, number_type=float):
    ...
    while True:
        ...
        try:
            ...
            if number_type.__name__ == "int":
                connector = "an"
            elif number_type.__name__ == "float":
                connector = "a"
            print(f"{prompt} as {connector} {number_type.__name__}.")
...
def main():
    ...
    savings_balance = validate_input("Enter the savings account balance ", float)
    ...
    print(f'New Balance: {updated_savings_balance:,.2f}, Earned Interest: {interest_earned:.2f}')
    ...
    print(f'New Balance: {updated_cd_balance:,.2f}, Earned Interest: {interest_earned:.2f}')
